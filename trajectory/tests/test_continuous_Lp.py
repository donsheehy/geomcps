import unittest
from trajectory.continuous_Lp import *
...
class TestContinuous_Lp(unittest.TestCase):
    def testcontinuousLp1(self):
        ...
        self.assertEqual(L_p(t1, t2, 1), 19.5)
    ...
    def testcontinuousLp2(self):
        ...
        self.assertEqual(L_p(t3, t4, 1), 8.0)
    ...
    def testcontinuousLp3(self):
        ...
        self.assertEqual(L_p(t5, t6, 1), 11.0/6.0)
    ...
    def testcontinuousLp4(self):
        ...
        self.assertEqual(L_p(t5, t6, 1), 5.5)
